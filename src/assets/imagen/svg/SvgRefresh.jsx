...
export default function SvgRefresh({fetchData}) {
  const [isLoading, setIsLoading] = useState(false);

  const handleClick = () => {
    setIsLoading(true);  // Activar la animación
    fetchData ()
    setTimeout(() => setIsLoading(false), 1000);  // Devolver la animación después de 1 segundo
  };
